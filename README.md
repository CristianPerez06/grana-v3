...
Los templates viven versionados en el repo bajo `supabase/templates/`. **El repo es la source of truth** — el dashboard de Supabase es un mirror manual, y lo va a seguir siendo: el proyecto no usa la CLI de Supabase, así que nadie va a subirlos por vos.
