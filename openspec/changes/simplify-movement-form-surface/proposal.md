...
- **Categoría en un tap (el recorte más grande).** Hoy elegir una categoría con subcategorías cuesta 3 taps por el drill obligatorio. El alta SHALL ofrecer las categorías recientes/frecuentes del usuario como chips de selección directa (un tap, sin abrir el popover ni entrar al drill), al estilo de la grilla de Mobills. Cada chip resuelve categoría **+ la cuenta más usada para esa categoría** (nivel 2), de modo que el patrón "kiosco → categoría + cuenta" ocurre en un tap sin tipear. El picker completo con drill queda como camino secundario ("Ver todas"). La subcategoría deja de ser un paso obligatorio: elegir la categoría alcanza para guardar.
