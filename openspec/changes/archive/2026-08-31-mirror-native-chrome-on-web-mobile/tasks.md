...
- [x] 4.4 **[ACEPTADO SIN CORRER — excepción escrita en `docs/qa-chrome-web-mobile.md`]** Verificar **en navegador** el `MovementDrawer` con el teclado abierto: el sheet tapa la barra y sube con el viewport (decisión 7 del design). No se puede confirmar sin un teclado virtual real → ver 7.4
...
- [x] 7.4 **[ACEPTADO SIN CORRER — excepción escrita en `docs/qa-chrome-web-mobile.md`]** `/transactions` → abrir el alta y enfocar el monto: la barra se esconde, el sheet queda por encima del teclado, y la barra vuelve al cerrarlo
- [x] 7.5 Redimensionar a 800px → sidebar de vuelta, sin tab bar, sin FAB, headers en el flujo del contenido
- [x] 7.6 **[ACEPTADO SIN CORRER — excepción escrita en `docs/qa-chrome-web-mobile.md`]** Instalar la PWA en un iPhone real → el navy llega hasta el notch y la barra respeta la home indicator. Es lo único que el DevTools no puede verificar
- [x] 7.7 **[ACEPTADO SIN CORRER — excepción escrita en `docs/qa-chrome-web-mobile.md`]** Repetir 7.1 y 7.4 en Android
