...
- [x] 7.2 Correr `pnpm verify` completo y dejarlo verde — **última corrida en verde el 22-09**, sobre el estado final de la rama (1047 tests de web, 24 de nativo y todos los packages, más lint, typecheck de las dos apps, build y los checks de salud). La primera corrida entera había sido el 18-09; entre las dos entraron el QA nativo, los hallazgos que se arreglaron y las dos rondas de revisión externa, así que la fecha vieja ya no decía nada sobre lo que hay en la rama. En la ronda anterior a la del 18-09 el registro de npm devolvía 503 y sólo se pudo correr eslabón por eslabón.
