...
- [ ] 4.2 Dejar registradas como changes siguientes **todas** las piezas que este change difiere a propósito. La lista completa, para que ninguna quede sólo anotada en la prosa del `proposal.md`:
  ...
  - ~~La regla de admisión a capabilities meta~~ — **SALDADA** por `capability-admission-rule` (archivada 2026-08-03). Cubre las tres capabilities meta, no sólo `project-conventions`, y distingue meta de cross-cutting para que `schema-base` y compañía tampoco funcionen como vertedero.
