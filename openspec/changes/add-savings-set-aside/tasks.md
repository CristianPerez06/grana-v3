...
- [ ] 9.5 **QA en la app nativa — BLOQUEADO, no pendiente.** El bloqueo es de acceso, no de trabajo: correrlo necesita la máquina del tech lead y no está disponible. No se puede destrabar desde acá y no hay que confundirlo con una tarea que nadie agarró. Vale igual para la fase 2 (`add-savings-purpose` 8.5): las dos partes del issue #58 esperan al mismo acceso.
