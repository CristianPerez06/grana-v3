...
SHALL haber **una sola apertura abierta por vez**: dos paneles apilados bajo una tira de tres columnas dejan de leerse como "esto pertenece a aquella columna". La apertura SHALL renderizarse **inmediatamente debajo de la fila que la abrió** siempre que la tira esté apilada —nativo, y web en pantalla angosta—, y debajo de la tira cuando esta se muestra en tres columnas. Nunca adentro de la columna: un tercio de una card de ancho de teléfono son ~105px y "Pago de tarjetas $968.558,83" no entra sin partirse o achicarse hasta dejar de leerse. Apilada, en cambio, un panel colgado al final de la tira se lee como parte de la última fila y no de la que se abrió, que es lo que hay que evitar.
...
#### Scenario: Apilada, la apertura queda pegada a su propia fila

- **WHEN** el usuario abre "Entró" en una pantalla angosta, donde los tres montos se apilan
- **THEN** la apertura aparece entre "Entró" y "Se fué", no al final de la tira
