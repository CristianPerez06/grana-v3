...
// (web-data-access spec): /dashboard and /transactions/recurring. Each wrapper
// is deleted as soon as its last consumer migrates. Do not add new read
// wrappers — new reads call the query functions directly with the browser
// client.
