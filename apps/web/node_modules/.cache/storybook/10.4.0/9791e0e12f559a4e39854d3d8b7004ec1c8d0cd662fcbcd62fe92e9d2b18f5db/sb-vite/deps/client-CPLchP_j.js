...
import { t as require_react_dom } from "./react-dom-BzjBl0o_.js";
//#region ../../node_modules/.pnpm/next@16.2.6_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/scheduler/cjs/scheduler.development.js
/**
* @license React
...
//#endregion
//#region ../../node_modules/.pnpm/next@16.2.6_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/scheduler/index.js
var require_scheduler = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_scheduler_development();
}));
//#endregion
//#region ../../node_modules/.pnpm/next@16.2.6_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react-dom/cjs/react-dom-client.development.js
/**
* @license React
...
var require_react_dom_client_development = /* @__PURE__ */ __commonJSMin(((exports) => {
	(function() {
		...
		function traverseVisibleHostChildren(child, searchWithinHosts, fn, a, b, c) {
			for (; null !== child;) {
				if ((5 === child.tag || 6 === child.tag) && fn(child, a, b, c) || (22 !== child.tag || null === child.memoizedState) && (searchWithinHosts || 5 !== child.tag) && traverseVisibleHostChildren(child.child, searchWithinHosts, fn, a, b, c)) return !0;
				child = child.sibling;
			}
			return !1;
		}
		...
		function addValueToProperties(propertyName, value, properties, indent, prefix) {
			switch (typeof value) {
				case "object": if (null === value) {
					...
					properties.push([prefix + "\xA0\xA0".repeat(indent) + propertyName, "Object" === propKey ? 3 > indent ? "" : "…" : propKey]);
		...
		function finishRenderingHooks(current, workInProgress) {
			...
			hookTypesUpdateIndexDev = -1;
			null !== current && (current.flags & 133169152) !== (workInProgress.flags & 133169152) && console.error("Internal React error: Expected static flag was missing. Please notify the React team.");
		...
		function updateSuspenseComponent(current, workInProgress, renderLanes) {
			var JSCompiler_object_inline_digest_2895;
			var JSCompiler_object_inline_stack_2896 = workInProgress.pendingProps;
			shouldSuspendImpl(workInProgress) && (workInProgress.flags |= 128);
			var JSCompiler_object_inline_message_2894 = !1;
			var didSuspend = 0 !== (workInProgress.flags & 128);
			(JSCompiler_object_inline_digest_2895 = didSuspend) || (JSCompiler_object_inline_digest_2895 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
			JSCompiler_object_inline_digest_2895 && (JSCompiler_object_inline_message_2894 = !0, workInProgress.flags &= -129);
			JSCompiler_object_inline_digest_2895 = 0 !== (workInProgress.flags & 32);
			workInProgress.flags &= -33;
			if (null === current) {
				if (isHydrating) {
					JSCompiler_object_inline_message_2894 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
					(current = nextHydratableInstance) ? (renderLanes = canHydrateHydrationBoundary(current, rootOrSingletonContext), renderLanes = null !== renderLanes && renderLanes.data !== ACTIVITY_START_DATA ? renderLanes : null, null !== renderLanes && (JSCompiler_object_inline_digest_2895 = {
						dehydrated: renderLanes,
						treeContext: getSuspendedTreeContext(),
						retryLane: 536870912,
						hydrationErrors: null
					}, workInProgress.memoizedState = JSCompiler_object_inline_digest_2895, JSCompiler_object_inline_digest_2895 = createFiberFromDehydratedFragment(renderLanes), JSCompiler_object_inline_digest_2895.return = workInProgress, workInProgress.child = JSCompiler_object_inline_digest_2895, hydrationParentFiber = workInProgress, nextHydratableInstance = null)) : renderLanes = null;
					if (null === renderLanes) throw warnNonHydratedInstance(workInProgress, current), throwOnHydrationMismatch(workInProgress);
					isSuspenseInstanceFallback(renderLanes) ? workInProgress.lanes = 32 : workInProgress.lanes = 536870912;
					return null;
				}
				var nextPrimaryChildren = JSCompiler_object_inline_stack_2896.children;
				JSCompiler_object_inline_stack_2896 = JSCompiler_object_inline_stack_2896.fallback;
				if (JSCompiler_object_inline_message_2894) {
					...
					JSCompiler_object_inline_stack_2896 = createFiberFromFragment(JSCompiler_object_inline_stack_2896, mode, renderLanes, null);
					nextPrimaryChildren.return = workInProgress;
					JSCompiler_object_inline_stack_2896.return = workInProgress;
					nextPrimaryChildren.sibling = JSCompiler_object_inline_stack_2896;
					workInProgress.child = nextPrimaryChildren;
					JSCompiler_object_inline_stack_2896 = workInProgress.child;
					JSCompiler_object_inline_stack_2896.memoizedState = mountSuspenseOffscreenState(renderLanes);
					JSCompiler_object_inline_stack_2896.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2895, renderLanes);
					workInProgress.memoizedState = SUSPENDED_MARKER;
					return bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2896);
				}
			...
			var prevState = current.memoizedState;
			if (null !== prevState) {
				var JSCompiler_object_inline_componentStack_2897 = prevState.dehydrated;
				if (null !== JSCompiler_object_inline_componentStack_2897) {
					if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2896.fallback, mode = workInProgress.mode, JSCompiler_object_inline_stack_2896 = mountWorkInProgressOffscreenFiber({
						mode: "visible",
						children: JSCompiler_object_inline_stack_2896.children
					}, mode), nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2, JSCompiler_object_inline_stack_2896.return = workInProgress, nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2896.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2896, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2896 = workInProgress.child, JSCompiler_object_inline_stack_2896.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2896.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2895, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2896));
					else if (pushPrimaryTreeSuspenseHandler(workInProgress), warnIfHydrating(), 0 !== (renderLanes & 536870912) && markRenderDerivedCause(workInProgress), isSuspenseInstanceFallback(JSCompiler_object_inline_componentStack_2897)) {
						JSCompiler_object_inline_digest_2895 = JSCompiler_object_inline_componentStack_2897.nextSibling && JSCompiler_object_inline_componentStack_2897.nextSibling.dataset;
						if (JSCompiler_object_inline_digest_2895) {
							nextPrimaryChildren = JSCompiler_object_inline_digest_2895.dgst;
							var message = JSCompiler_object_inline_digest_2895.msg;
							mode = JSCompiler_object_inline_digest_2895.stck;
							var componentStack = JSCompiler_object_inline_digest_2895.cstck;
						}
						JSCompiler_object_inline_message_2894 = message;
						JSCompiler_object_inline_digest_2895 = nextPrimaryChildren;
						JSCompiler_object_inline_stack_2896 = mode;
						JSCompiler_object_inline_componentStack_2897 = componentStack;
						nextPrimaryChildren = JSCompiler_object_inline_message_2894;
						mode = JSCompiler_object_inline_componentStack_2897;
						...
						nextPrimaryChildren.stack = JSCompiler_object_inline_stack_2896 || "";
						nextPrimaryChildren.digest = JSCompiler_object_inline_digest_2895;
						JSCompiler_object_inline_digest_2895 = void 0 === mode ? null : mode;
						JSCompiler_object_inline_stack_2896 = {
							value: nextPrimaryChildren,
							source: null,
							stack: JSCompiler_object_inline_digest_2895
						};
						"string" === typeof JSCompiler_object_inline_digest_2895 && CapturedStacks.set(nextPrimaryChildren, JSCompiler_object_inline_stack_2896);
						queueHydrationError(JSCompiler_object_inline_stack_2896);
						workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
					} else if (didReceiveUpdate || propagateParentContextChanges(current, workInProgress, renderLanes, !1), JSCompiler_object_inline_digest_2895 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2895) {
						JSCompiler_object_inline_digest_2895 = workInProgressRoot;
						if (null !== JSCompiler_object_inline_digest_2895 && (JSCompiler_object_inline_stack_2896 = getBumpedLaneForHydration(JSCompiler_object_inline_digest_2895, renderLanes), 0 !== JSCompiler_object_inline_stack_2896 && JSCompiler_object_inline_stack_2896 !== prevState.retryLane)) throw prevState.retryLane = JSCompiler_object_inline_stack_2896, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2896), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2895, current, JSCompiler_object_inline_stack_2896), SelectiveHydrationException;
						isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2897) || renderDidSuspendDelayIfPossible();
						workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
					} else isSuspenseInstancePending(JSCompiler_object_inline_componentStack_2897) ? (workInProgress.flags |= 192, workInProgress.child = current.child, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_componentStack_2897.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && restoreSuspendedTreeContext(workInProgress, current), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2896.children), workInProgress.flags |= 4096);
					return workInProgress;
				}
			}
			if (JSCompiler_object_inline_message_2894) return reuseSuspenseHandlerOnStack(workInProgress), nextPrimaryChildren = JSCompiler_object_inline_stack_2896.fallback, mode = workInProgress.mode, componentStack = current.child, JSCompiler_object_inline_componentStack_2897 = componentStack.sibling, JSCompiler_object_inline_stack_2896 = createWorkInProgress(componentStack, {
				mode: "hidden",
				children: JSCompiler_object_inline_stack_2896.children
			}), JSCompiler_object_inline_stack_2896.subtreeFlags = componentStack.subtreeFlags & 133169152, null !== JSCompiler_object_inline_componentStack_2897 ? nextPrimaryChildren = createWorkInProgress(JSCompiler_object_inline_componentStack_2897, nextPrimaryChildren) : (nextPrimaryChildren = createFiberFromFragment(nextPrimaryChildren, mode, renderLanes, null), nextPrimaryChildren.flags |= 2), nextPrimaryChildren.return = workInProgress, JSCompiler_object_inline_stack_2896.return = workInProgress, JSCompiler_object_inline_stack_2896.sibling = nextPrimaryChildren, workInProgress.child = JSCompiler_object_inline_stack_2896, bailoutOffscreenComponent(null, JSCompiler_object_inline_stack_2896), JSCompiler_object_inline_stack_2896 = workInProgress.child, nextPrimaryChildren = current.child.memoizedState, null === nextPrimaryChildren ? nextPrimaryChildren = mountSuspenseOffscreenState(renderLanes) : (mode = nextPrimaryChildren.cachePool, null !== mode ? (componentStack = CacheContext._currentValue, mode = mode.parent !== componentStack ? {
				parent: componentStack,
				pool: componentStack
			} : mode) : mode = getSuspendedCache(), nextPrimaryChildren = {
				baseLanes: nextPrimaryChildren.baseLanes | renderLanes,
				cachePool: mode
			}), JSCompiler_object_inline_stack_2896.memoizedState = nextPrimaryChildren, JSCompiler_object_inline_stack_2896.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2895, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, bailoutOffscreenComponent(current.child, JSCompiler_object_inline_stack_2896);
			...
			null !== current && (JSCompiler_object_inline_digest_2895 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2895 ? (workInProgress.deletions = [current], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2895.push(current));
		...
		function bubbleProperties(completedWork) {
			...
			if (didBailout) if ((completedWork.mode & ProfileMode) !== NoMode) {
				for (var _treeBaseDuration = completedWork.selfBaseDuration, _child2 = completedWork.child; null !== _child2;) newChildLanes |= _child2.lanes | _child2.childLanes, subtreeFlags |= _child2.subtreeFlags & 133169152, subtreeFlags |= _child2.flags & 133169152, _treeBaseDuration += _child2.treeBaseDuration, _child2 = _child2.sibling;
				completedWork.treeBaseDuration = _treeBaseDuration;
			} else for (_treeBaseDuration = completedWork.child; null !== _treeBaseDuration;) newChildLanes |= _treeBaseDuration.lanes | _treeBaseDuration.childLanes, subtreeFlags |= _treeBaseDuration.subtreeFlags & 133169152, subtreeFlags |= _treeBaseDuration.flags & 133169152, _treeBaseDuration.return = completedWork, _treeBaseDuration = _treeBaseDuration.sibling;
			...
			if (null !== ref) {
				switch (finishedWork.tag) {
					...
					case 30:
						...
						break;
					case 7:
						null === finishedWork.stateNode && (instanceToUse = new FragmentInstance(finishedWork), traverseFragmentInstance(finishedWork, addFragmentHandleToFiber, instanceToUse), finishedWork.stateNode = instanceToUse);
						instanceToUse = finishedWork.stateNode;
						break;
		...
		function commitNewChildToFragmentInstances(fiber, parentFragmentInstances) {
			if ((5 === fiber.tag || 6 === fiber.tag) && null === fiber.alternate && null !== parentFragmentInstances) for (var i = 0; i < parentFragmentInstances.length; i++) commitNewChildToFragmentInstance(fiber.stateNode, parentFragmentInstances[i]);
		}
		function commitFragmentInstanceDeletionEffects(fiber) {
			for (var parent = fiber.return; null !== parent;) {
				if (isFragmentInstanceParent(parent)) {
					var childInstance = fiber.stateNode, fragmentInstance = parent.stateNode;
		...
		function commitDeletionEffectsOnFiber(finishedRoot, nearestMountedAncestor, deletedFiber) {
			...
			switch (deletedFiber.tag) {
				...
				case 27:
					...
					break;
				case 5: offscreenSubtreeWasHidden || safelyDetachRef(deletedFiber, nearestMountedAncestor), 5 !== deletedFiber.tag && 6 !== deletedFiber.tag || commitFragmentInstanceDeletionEffects(deletedFiber);
				case 6:
		...
		function commitMutationEffectsOnFiber(finishedWork, root, lanes) {
			...
			switch (finishedWork.tag) {
						...
						a: {
							...
							b: switch (current) {
								...
								case "meta":
									...
									lanes.head.appendChild(flags);
									break;
								default: throw Error("getNodesForType encountered a type it did not expect: \"" + current + "\". This is a bug in React.");
							}
							flags[internalInstanceKey] = finishedWork;
							markNodeAsHoistable(flags);
							current = flags;
				...
				case 22:
					...
					i && !hoistableRoot && !prevOffscreenSubtreeIsHidden && !prevOffscreenSubtreeWasHidden && (finishedWork.mode & ProfileMode) !== NoMode && 0 <= componentEffectStartTime && 0 <= componentEffectEndTime && .05 < componentEffectEndTime - componentEffectStartTime && logComponentReappeared(finishedWork, componentEffectStartTime, componentEffectEndTime);
					commitReconciliationEffects(finishedWork);
				...
				case 30:
					...
					break;
				case 21: break;
				case 7: current && null !== current.stateNode && (current.stateNode._fragmentFiber = finishedWork);
		...
		function disappearLayoutEffects(finishedWork) {
			...
			switch (finishedWork.tag) {
				...
				case 5:
					safelyDetachRef(finishedWork, finishedWork.return);
					5 !== finishedWork.tag && 6 !== finishedWork.tag || commitFragmentInstanceDeletionEffects(finishedWork);
					recursivelyTraverseDisappearLayoutEffects(finishedWork);
					break;
				case 22:
		...
		function flushSpawnedWork() {
			if (pendingEffectsStatus === PENDING_SPAWNED_WORK || pendingEffectsStatus === PENDING_AFTER_MUTATION_PHASE) {
				...
				0 !== (abortedViewTransition & 261930) && 0 !== (remainingLanes & 42) ? (nestedUpdateScheduled = !0, endTime === rootWithNestedUpdates ? nestedUpdateCount++ : (nestedUpdateCount = 0, rootWithNestedUpdates = endTime)) : nestedUpdateCount = 0;
		...
		FragmentInstance.prototype.removeEventListener = function(type, listener, optionsOrUseCapture) {
			var listeners = this._eventListeners;
			null !== listeners && "undefined" !== typeof listeners && 0 < listeners.length && (traverseFragmentInstance(this._fragmentFiber, removeEventListenerFromChild, type, listener, optionsOrUseCapture), type = indexOfEventListener(listeners, type, listener, optionsOrUseCapture), null !== this._eventListeners && this._eventListeners.splice(type, 1));
		};
		...
		FragmentInstance.prototype.blur = function() {
			...
			if (null !== parentHostFiber) {
				...
				null !== activeElement && parentHostFiber.contains(activeElement) && traverseFragmentInstance(this._fragmentFiber, blurActiveElementWithinFragment, activeElement);
			}
		};
		FragmentInstance.prototype.observeUsing = function(observer) {
			var hasText = !1, hasElement = !1;
			traverseFragmentInstance(this._fragmentFiber, function(child) {
		...
		FragmentInstance.prototype.unobserveUsing = function(observer) {
			...
			null !== observers && observers.has(observer) ? (observers.delete(observer), traverseFragmentInstance(this._fragmentFiber, unobserveChild, observer)) : console.error("You are calling unobserveUsing() with an observer that is not being observed with this fragment instance. First attach the observer with observeUsing()");
		};
		...
		FragmentInstance.prototype.compareDocumentPosition = function(otherNode) {
			...
			for (var foundPortalParent = !1, parent = this._fragmentFiber.return; null !== parent;) {
		...
		FragmentInstance.prototype.scrollIntoView = function(alignToTop) {
			...
			if (0 === children.length) {
			...
			} else for (result = resolvedAlignToTop ? children.length - 1 : 0; result !== (resolvedAlignToTop ? -1 : children.length);) {
				...
				} else getInstanceFromHostFiber(parentHostFiber).scrollIntoView(alignToTop);
...
//#endregion
//#region ../../node_modules/.pnpm/next@16.2.6_@babel+core@7.29.0_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/next/dist/compiled/react-dom/client.js
...
//# sourceMappingURL=client-CPLchP_j.js.map