...
Handoff visual (2 rows de 38 px; atajos `Mitad · 70/30 · 75/25 · 80/20 · 100% · Otro` + barra de reparto "Vos / [integrante del Hogar]"; "Otro" abre dos campos %) en [`compartir/README.md`](./compartir/README.md) + canvas [`compartir/compartir-bloque-final.html`](./compartir/compartir-bloque-final.html). ⚠️ **Reemplaza** lo que la propuesta OpenSpec tenía para Compartido (presets Vos/Mitad/El otro + "Otro %"): actualizar spec al implementar. El estado `splitFirstPct` alcanza.
