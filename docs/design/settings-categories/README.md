...
Para corregir el patron de formularios en rutas dedicadas (`/new` y `/edit`), ver tambien `docs/design/settings-category-drawers/`. Ese bundle propone que crear/editar categoria se abra en drawer desde esta lista.
